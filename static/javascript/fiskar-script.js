...
var current_index = 0;
var max_index = fiskar.length-1;
var path_to_images = './static/fiskar/';
...
function setDisplay(){
    img_src = path_to_images+fiskar[current_index]['src'];
    latin_text.textContent = fiskar[current_index]['latin'];
    svenska_text.textContent = fiskar[current_index]['swe'];
